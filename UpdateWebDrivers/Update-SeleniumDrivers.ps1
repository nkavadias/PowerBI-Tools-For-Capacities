<#
    ...
    https://github.com/wiktormrowczynski/PowerShell/tree/main/Automate%20Update%20of%20Selenium%20Web%20Driver

    # broken code to update chrome/edge web driver for selenium. for now, download https://storage.googleapis.com/chrome-for-testing-public/134.0.6998.88/win64/chromedriver-win64.zip or latest ver 
    into C:\Users\SAnkavadias\OneDrive - NSW Department of Education (1)\Documents\PowerShell\Modules\Selenium\3.0.1\assemblies
    v.2022.06.22.A
#>
